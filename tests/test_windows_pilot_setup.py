...
class WindowsPilotSetupTests(unittest.TestCase):
    ...
    def test_windows_ci_uses_persistent_directory_extension_and_session_e2e(self) -> None:
        ...
        self.assertNotIn('"DOM.setFileInputFiles"', loader)
        self.assertIn("files: [extension]", loader)
        self.assertIn('type: "dragEnter"', loader)
        self.assertIn('addEventListener("dragenter"', loader)
        self.assertIn("webkitGetAsEntry", loader)
        self.assertIn("__ciDraggedDirectoryEntry", loader)
        self.assertIn("chrome.developerPrivate.loadDirectory", loader)
        self.assertIn('type: "dragCancel"', loader)
        self.assertIn("CHROME_DIRECTORY_ENTRY", loader)
